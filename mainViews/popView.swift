...
import UIKit
struct popView: View {
    var gradient: [Color] = [Color("Pop"), Color("Pop2")]
...
struct pop1: View {
    ...
    @State private var activeAlert: ActiveAlertPop = .first
    @State private var activeAlertTwo: ActiveAlertPop = .second
    ...
    @ObservedObject var popsettings = popSettings()
    ...
    var body: some View {
        VStack (alignment: .leading, spacing: 20) {
            ...
            Text("Song Title:")
                ...
                .foregroundColor(Color.white)
        TextView(text: $popsettings.songTitlePopOne, textStyle: $textStyle)
                //            .padding()
            ...
            Text("Song Lyrics:")
                .font(Font.custom("Lobster 1.4", size: 22))
                .foregroundColor(Color.white)
            TextView(text: $popsettings.songLyricsPopOne, textStyle: $textStyle)
                //      .padding(10)
                .background(Color(UIColor.tertiarySystemFill))
                .cornerRadius(9)
            ...
            HStack {
                   ...
                   Button(action: {
                    ...
                    self.playbackButton = Image(systemName: "waveform.circle")
                       ...
                       if (self.playButton == Image(systemName: "play.circle")) {
                           print("All Done")
                           self.recordingsettings.playSound(sound: "Pop 8", type: "caf")
                ...
                Button(action: {
                    ...
                    let fileName = path.appendingPathComponent("Pop Recording.caf")
                    ...
                    if (self.recordButton == Image(systemName: "mic.circle")) {
                        self.recordingsettings.setUpAudio(sound: "Pop 8.caf")
                        self.recordingsettings.timer = Timer.publish(every: 1, on: .main, in: .common).autoconnect()
                        self.recordingsettings.playSoundThree(sound: "Pop 8", type: "caf")
                        self.recordingsettings.songDuration = 146.00
                        let currentTime = self.recordingsettings.audioPlayerThree?.currentTime
                        self.recordingsettings.playValue = currentTime!
                        self.recordingsettings.timer = Timer.publish(every: 1, on: .main, in: .common).autoconnect()

                        try! self.recordingsettings.startRecording(sound: "Pop Recording.caf")
            ...
            //            showingAlertHeadphones = true
                ...
                .alert(isPresented: $showAlert) {
                    ...
                    case .second:
                        return Alert(title: Text("Are you sure you want to overwrite your banging pop tune?"), primaryButton: .destructive(Text("Let's go!")){
                            if (self.recordButton == Image(systemName: "mic.circle")) {
             ...
             Button(action: {
                ...
                if self.playbackButton == Image(systemName: "waveform.circle") {
                    ...
                    self.recordingsettings.playSoundTwo(sound: "Pop Recording.caf")
