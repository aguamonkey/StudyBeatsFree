...
class reggaeSettings: ObservableObject {
    @Published var songTitleReggaeOne: String {
        didSet {
            UserDefaults.standard.set(songTitleReggaeOne, forKey: "songTitleReggaeOne")
        }
    }
    
    @Published var songLyricsReggaeOne: String {
        didSet {
            UserDefaults.standard.set(songLyricsReggaeOne, forKey: "songLyricsReggaeOne")
        }
    }
    ...
    init() {
        self.songTitleReggaeOne = UserDefaults.standard.object(forKey: "songTitleReggaeOne") as? String ?? ""
        self.songLyricsReggaeOne = UserDefaults.standard.object(forKey: "songLyricsReggaeOne") as? String ?? ""
