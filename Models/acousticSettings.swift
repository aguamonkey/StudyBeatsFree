//
//  acousticSettings.swift
//  StudyBeatsFree
//
//  Created by Gobias LTD on 24/02/2021.
//

import Foundation
import Combine

class acousticSettings: ObservableObject {
    @Published var songTitleAcousticOne: String {
        didSet {
            UserDefaults.standard.set(songTitleAcousticOne, forKey: "songTitleAcousticOne")
        }
    }
    
    @Published var songLyricsAcousticOne: String {
        didSet {
            UserDefaults.standard.set(songLyricsAcousticOne, forKey: "songLyricsAcousticOne")
        }
    }
    ...
    init() {
        self.songTitleAcousticOne = UserDefaults.standard.object(forKey: "songTitleAcousticOne") as? String ?? ""
        self.songLyricsAcousticOne = UserDefaults.standard.object(forKey: "songLyricsAcousticOne") as? String ?? ""
