...
class countrySettings: ObservableObject {
    @Published var songTitleCountryOne: String {
        didSet {
            UserDefaults.standard.set(songTitleCountryOne, forKey: "songTitleCountryOne")
        }
    }
    
    @Published var songLyricsCountryOne: String {
        didSet {
            UserDefaults.standard.set(songLyricsCountryOne, forKey: "songLyricsCountryOne")
        }
    }
    ...
    init() {
        self.songTitleCountryOne = UserDefaults.standard.object(forKey: "songTitleCountryOne") as? String ?? ""
        self.songLyricsCountryOne = UserDefaults.standard.object(forKey: "songLyricsCountryOne") as? String ?? ""
